...
filesyscalls.o: ${S}/userprog/filesyscalls.c
	${COMPILE.c} ${S}/userprog/filesyscalls.c
SRCS+=${S}/userprog/filesyscalls.c
OBJS+=filesyscalls.o

procsyscalls.o: ${S}/userprog/procsyscalls.c
	${COMPILE.c} ${S}/userprog/procsyscalls.c
SRCS+=${S}/userprog/procsyscalls.c
OBJS+=procsyscalls.o

fdtable.o: ${S}/userprog/fdtable.c
	${COMPILE.c} ${S}/userprog/fdtable.c
SRCS+=${S}/userprog/fdtable.c
OBJS+=fdtable.o

proctable.o: ${S}/userprog/proctable.c
	${COMPILE.c} ${S}/userprog/proctable.c
SRCS+=${S}/userprog/proctable.c
OBJS+=proctable.o
